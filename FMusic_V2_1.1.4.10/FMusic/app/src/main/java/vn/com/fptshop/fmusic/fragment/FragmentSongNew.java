...
public class FragmentSongNew extends Fragment implements OnItemClickListener<Song>, SearchView.OnQueryTextListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // setHasOptionsMenu(true);
        ...
        PlayMusicService playerService = new PlayMusicService();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_song_new, container, false);
        ...
        listSong = db.getSongsLimit(offset, limit);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (fragmentPlaySong != null && fragmentPlaySong.isVisible()) {
                    ...
                    System.out.println("IDD: " + listSong.get(position).getSongId());
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (list.getLastVisiblePosition() >= count - threshold) {
                        ...
                        List<Song> rs = db.getSongsLimit(offset, limit);
                        listSong.addAll(rs);
                        ...
                        if (fragmentPlaySong != null && fragmentPlaySong.isVisible()) {
                            //VISIBLE
                            System.out.println("VISIBLE: ");
                            fragmentPlaySong.updateSongList((ArrayList<Song>) listSong);
                        }
...
//                            fragmentTransaction.hide(test);
//                            System.out.println("Visbile");
//
//                        } else {
//                            System.out.println("IN Visbile");
//                        }
//                        fragmentTransaction.commit();
                    }
...
//                }
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        if (newText.length() > 0) {
            ...
            offset = 0;
            limit = 20;
            listSong.addAll(db.getSongsLimit(offset, limit));
            adapter.notifyDataSetChanged();
        }
        return false;
    }
