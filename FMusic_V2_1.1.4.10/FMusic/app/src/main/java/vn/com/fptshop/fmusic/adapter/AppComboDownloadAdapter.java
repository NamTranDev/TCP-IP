 ...
 */
public class AppComboDownloadAdapter extends BaseAdapter {
    ...
    public AppComboDownloadAdapter(Context context, List<AppCombo> d) {
...
//        holder.proccess.setVisibility(View.GONE);
        ...
        holder.download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                    mListener.onItemClickAppCombo(v, pos, appCombo);
                }
            }
        });
        return convertView;
