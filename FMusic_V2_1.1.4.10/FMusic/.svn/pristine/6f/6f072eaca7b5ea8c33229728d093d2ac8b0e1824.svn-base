...
/**
 * Created by MinhDH on 12/21/15.
 */
public class AppDownloaderAdapter extends BaseAdapter {
    private List<App> mAppInfos;
    private Context context;
    private IOnClickAppDownloader mListener;

    public AppDownloaderAdapter(Context context) {
        this.mAppInfos = new ArrayList<App>();
        this.context = context;
    }

    public AppDownloaderAdapter(Context context, List<App> apps) {
        this.context = context;
        this.mAppInfos = apps;
    }

    public void setOnItemClickListener(IOnClickAppDownloader listener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mListener != null) {
                    mListener.onClick(v, position, appInfo);
                }
            }
        });
        return convertView;
