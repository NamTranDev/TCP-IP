...
public class ImageManager {
    ...
    public void displayImage(final String url, final ImageView imageView, final int defaultDrawableId) {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (imageMap.containsKey(url)) {
                    System.out.println("imageMap: " + imageMap.get(url));
             ...
             /*
                    ...
                    queueImage(url, imageView, defaultDrawableId);
                    System.out.println("queueImage: " + defaultDrawableId);
...
/*
                ...
                System.out.println("bit " + bitmapTimeMillis + " " + openConnection.getLastModified());
...
//                long lastModTimeMillis = mDateFormatter.parse(lastMod).getTime();
                ...
                long lastModTimeMillis = openConnection.getLastModified();
