 ...
 */
public class FragmentGenreDetail extends Fragment implements OnItemClickListener<Song>, OnQueryTextListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            if (bundle.containsKey("genre")) {
                genreTemp = bundle.getString("genre");
            }
        }
        tokenizer = new StringTokenizer(genreTemp, "_");
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(genreName);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_genre_detail, container, false);
