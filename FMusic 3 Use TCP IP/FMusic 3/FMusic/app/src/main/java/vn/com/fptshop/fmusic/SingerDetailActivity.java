...
public class SingerDetailActivity extends AppCompatActivity implements OnItemClickListener<Song>,SearchView.OnQueryTextListener {
    DatabaseHandler db;
    Context context;
    int offset = 0;
    int limit = 20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String singerTemp = i.getStringExtra("singer");
        StringTokenizer tokenizer = new StringTokenizer(singerTemp,"_");
        int singerId = 0;
        String singerName = "";
        int totalSongs = 0;
        ...
        System.out.println(listSong.size() + " " + singerId) ;
