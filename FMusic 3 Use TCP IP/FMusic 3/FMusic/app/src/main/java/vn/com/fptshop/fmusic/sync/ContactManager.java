...
public class ContactManager {
    ...
    Context mContext;
    IOnProccessListener listener;

    public ContactManager(Context context, IOnProccessListener listener) {
...
//            System.out.println("SIZE " + cur.getCount());
            ...
            if (cur.getCount() > 0) {
                while (cur.moveToNext()) {
                    ...
                    listener.proccess("Đồng bộ " + count + "/" + size + " liên hệ.");
                }
            }
...
//        if (contactExistsName("")) {
//            System.out.println("Trung " + contact.getName());
...
//        } else {
        ...
        try {
            ...
            AppSetting.proccess = "Đồng bộ " + ++AppSetting.constactInsert + "/" + AppSetting.constactSize + " liên hệ.";
...
//        }
    ...
    public boolean contactExistsName(String key) {
        try {
            ContentResolver cr = mContext.getContentResolver();
            Cursor cur = cr.query(Contacts.CONTENT_URI, null, null, null, null);
            if (cur.getCount() > 0) {
    ...
    public boolean contactExists(Context mContext, String number) {
        if (number != null) {
            Uri lookupUri = Uri.withAppendedPath(PhoneLookup.CONTENT_FILTER_URI, Uri.encode(number));
            System.out.println(lookupUri);
